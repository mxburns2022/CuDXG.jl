...
override = false
epsilon = [1e-4, 1e-6]
algorithms = ["annealed_sinkhorn", "hpd", "lamp", "apdamd", "sinkhorn", "acc_sinkhorn"]
for (size,  solver,eps, (ind1, ind2), probclass) in product(sizes, algorithms, epsilon, instance_pairs, benchmark_classes)
    ...
    # Format output file as <problem_class>_<resolution>_<index of img1>_<index of img2>_<η value>_<solver_name>_log.csv
