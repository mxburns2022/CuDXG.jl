...
for (size, eps, (ind1, ind2), probclass) in product(sizes, epsilon, instance_pairs, benchmark_classes)
    ...
    output_file = join([lowercase(probclass), size, ind1, ind2, epsstring], "_") * "_log.csv"
